...
8. Here is the magic: 'wget https://raw.githubusercontent.com/jimbodragon/initialize_chef_repo/master/initializator.sh && bash initializator.sh Exemple Test Dev QA SIT DR'
